...
**이 페이지의 스크린샷을 넣을 위치**: 
```
## 🎯 핵심 기능 > 1️⃣ 메인 페이지 아래에 이미지 추가
![Screenshot: 메인 페이지 - 지도와 크루 리스트](/screenshots/main_page.png)
```
...
**이 페이지의 스크린샷을 넣을 위치**: 
```
## 🎯 핵심 기능 > 2️⃣ 예약 시스템 아래에 이미지 추가
![Screenshot: 크루 상세정보](/screenshots/explanation_page.png)
![Screenshot: 예약 페이지](/screenshots/reserve_page.png)
```
...
![Screenshot: 마이페이지 프로필](/screenshots/userpage_profile.png)
![Screenshot: 스탐프 시스템](/screenshots/userpage_stamps.png)
![Screenshot: 북마크 관리](/screenshots/userpage_bookmarks.png)
```
...
**이 페이지의 스크린샷을 넣을 위치**: 
```
## 🎯 핵심 기능 > 4️⃣ 커뮤니티 아래에 이미지 추가
![Screenshot: ON CREW 페이지](/screenshots/oncrew_page.png)
![Screenshot: ON GEAR 페이지](/screenshots/ongear_page.png)
![Screenshot: ON PROGRAM 페이지](/screenshots/onprogram_page.png)
```
...
![Screenshot: QnA 페이지](/screenshots/qna_page.png)
![Screenshot: Contact 페이지](/screenshots/contact_page.png)
```
...
![Screenshot: 로그인 페이지](/screenshots/login_page.png)
![Screenshot: 회원가입 페이지](/screenshots/signup_page.png)
```
